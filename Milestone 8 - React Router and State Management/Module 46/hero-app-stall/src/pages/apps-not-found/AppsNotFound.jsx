        ...
        <div>
            ...
            <div className='bg-[#f5f5f5] px-4 md:px-0'>
                <div className='max-w-360 mx-auto py-20 flex flex-col justify-center items-center'>
                    ...
                    <h1 className='font-semibold text-[20px] xs:text-3xl sm:text-[48px] leading-15 text-[#001931] mt-4 text-center'>OPPS!! APPS NOT FOUND</h1>
                    <p className='font-normal text-[20px] leading-8 text-[#627382] mt-2 mb-4 text-center'>The Apps you are requesting are not found on our system.  please retry</p>
